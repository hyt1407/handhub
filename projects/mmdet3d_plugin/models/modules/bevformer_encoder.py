...
from projects.mmdet3d_plugin.models.modules.custom_base_transformer_layer import MyCustomBaseTransformerLayer
...
class BevformerEncoder(TransformerLayerSequence):
    ...
    def __init__(self, *args, pc_range=None, grid_config=None, data_config=None, return_intermediate=False,
                 dataset_type='nuscenes', fix_bug=False,
                 **kwargs):
