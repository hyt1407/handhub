...
class DetrTransformerDecoder(BaseModule):
    ...
    def __init__(self,
                 num_layers: int,
                 layer_cfg: Dict,
                 post_norm_cfg: Optional[Dict] = dict(type='LN'),
                 return_intermediate: bool = True,
                 init_cfg: Union[dict, Dict] = None) -> None:
        super().__init__(init_cfg=init_cfg)
        self.layer_cfg = layer_cfg
        self.num_layers = num_layers
...
class DetrTransformerEncoderLayer(BaseModule):
    ...
    def __init__(self,
                 self_attn_cfg: Optional[Dict] = dict(
                     embed_dims=256, num_heads=8, dropout=0.0),
                 ffn_cfg: Optional[Dict] = dict(
                     embed_dims=256,
...
class DetrTransformerDecoderLayer(BaseModule):
    ...
    def __init__(self,
                 self_attn_cfg: Optional[Dict] = dict(
                     ...
                     dropout=0.0,
                     batch_first=True),
                 cross_attn_cfg: Optional[Dict] = dict(
                     embed_dims=256,
                     num_heads=8,
                     dropout=0.0,
                     batch_first=True),
